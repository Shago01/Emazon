...
public class StockRestController {
    ...
    @Operation(
            ...
            description = "Este endpoint permite obtener una lista de categorías con paginación y ordenamiento. " +
                    ...
                    "El campo por el que se ordenan las categorías es fijo como 'name'. " +
                    "También se puede elegir la dirección del ordenamiento (ascendente o descendente). " +
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "No se encontraron categorías con los parámetros proporcionados",
                            content = {
                                    @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json",
                                            schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = ResponseException.class))
                            }),
    ...
    public ResponseEntity<List<CategoryRes>> getAllCategoriesByOrder(
        ...
        List<Category> listCategory = categoryHandler.getAllCategories(page, size, asc);
